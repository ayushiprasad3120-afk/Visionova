          ...
          <div>
            ...
            <Reveal delay={0.4}>
              <p className="mt-7 max-w-lg text-base md:text-lg leading-relaxed text-charcoal/70 dark:text-cream/70">
                VisionovaHQ pairs verified, fraud-filtered traffic with performance-driven campaigns across 190+ countries — built for advertisers and publishers who expect more than volume.
              </p>
            </Reveal>
          ...
          >
            <div className="relative rounded-xl2 border border-white/40 dark:border-white/10 card-surface shadow-soft p-6">
              ...
              <div className="mt-6 space-y-4">
                {[
                  { label: "Conversion Rate", value: 82 },
                  { label: "Traffic Quality Score", value: 96 },
                  { label: "Fraud Filter", value: 99 },
                ].map((row, i) => (
                  <div key={row.label}>
            ...
            >
              <p className="text-xs opacity-80">Impressions today</p>
              <p className="font-display text-xl">4.2M+</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
