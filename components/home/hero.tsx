...
import { ChevronDown, Eye, MousePointerClick, PhoneCall, Headset } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
          ...
          >
            <div className="relative rounded-xl2 border border-white/40 dark:border-white/10 card-surface shadow-soft p-6">
              ...
              <div className="mt-7 relative pl-2">
                ...
                <div className="space-y-7">
                  {[
                    { icon: Eye, title: "Sees the Ad", desc: "A relevant ad appears" },
                    { icon: MousePointerClick, title: "Searches & Clicks", desc: "Interest turns into action" },
                    { icon: PhoneCall, title: "Connects by Phone", desc: "A call is placed in real time" },
                    { icon: Headset, title: "Agent Responds", desc: "The call is answered and handled" },
                  ].map((step, i) => (
                    <motion.div
                      key={step.title}
              ...
              <div className="mt-7 grid grid-cols-2 gap-3">
                <div className="rounded-xl bg-charcoal/[0.03] dark:bg-cream/[0.05] p-3 text-center">
                  <p className="font-display text-lg text-wine">Seamless</p>
                  <p className="text-[11px] text-charcoal/50 dark:text-cream/50 mt-0.5">Ad-to-Call Journey</p>
                </div>
                <div className="rounded-xl bg-charcoal/[0.03] dark:bg-cream/[0.05] p-3 text-center">
                  <p className="font-display text-lg text-wine">Live</p>
                  <p className="text-[11px] text-charcoal/50 dark:text-cream/50 mt-0.5">Agent Handoff</p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p className="font-display text-xl">Connected</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
