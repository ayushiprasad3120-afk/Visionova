...
const ENDPOINT = process.env.NEXT_PUBLIC_PUBLISHER_FORM_ENDPOINT;
...
export function PublisherForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setError(null);
    try {
      await submitForm(ENDPOINT, e.currentTarget, { _subject: "New VisionovaHQ Publisher Application" });
      setSubmitted(true);
    } catch (err) {
