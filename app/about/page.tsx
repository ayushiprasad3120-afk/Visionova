    ...
    <>
      ...
      <section className="py-20 md:py-28">
        <div className="container-editorial grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <Reveal delay={0.15}>
            <div className="text-charcoal/70 dark:text-cream/70 leading-relaxed">
              <p>
                VisionovaHQ connects advertisers and publishers through quality traffic, performance-driven campaigns, and trusted partnerships across global markets.
              </p>
            </div>
          </Reveal>
        </div>
