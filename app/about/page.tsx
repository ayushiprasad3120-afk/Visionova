...
const pillars = [
  ...
  { icon: Globe2, title: "Global Reach", desc: "A verified network spanning 190+ countries, connecting demand and supply across every major market." },
        ...
        <div className="container-editorial grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <Reveal delay={0.15}>
            <div className="space-y-5 text-charcoal/70 dark:text-cream/70 leading-relaxed">
              ...
              <p>
                Today, VisionovaHQ operates across 190+ countries and a dozen major verticals, powered by proprietary fraud detection and a team of dedicated performance specialists who measure success the same way our partners do: in real, sustainable growth.
              </p>
            </div>
          </Reveal>
        </div>
